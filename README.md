...
## 👥 Автори:
 - **Гайдук Максим Олександрович**: Дослідник та провідний розробник застосунку, відповідальний за ключові етапи проєктування та впровадження функціональних рішень.
 - **Бороденко Роман Андрійович**: Відповідав за розробку та оптимізацію UI/UX дизайну проєкту. Виконував тестування функціоналу та активно займався виявленням і виправленням помилок для підвищення стабільності та якості продукту.
